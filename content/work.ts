...
export const brands: Brand[] = [
  {
    ...
    description: [
      "오늘은 동네 배드민턴 클럽과 동호인이 매일 겪는 일을 다루는 서비스 시리즈입니다. 모임을 만들고, 대회를 찾고, 코트에서 만나는 하루를 조금 더 단순하게 만듭니다.",
      "각 서비스는 하나의 불편에서 출발합니다. 단톡방 세 개로 돌아가던 모임 운영, 흩어져 있는 대회 정보 같은 것들입니다.",
    ],
    since: "2025",
  },
];
...
export const products: Product[] = [
  ...
  },
  {
    ...
    description: [
      "전국에서 열리는 배드민턴 대회 정보를 한곳에 모으고, 참가 신청과 일정 관리를 돕는 서비스입니다. 준비 중이며 공개 시점에 자세한 내용을 안내합니다.",
    ],
    status: "soon",
    brand: "oneul",
    period: { from: "2026" },
  },
  {
    ...
    description: [
      "전국 각지의 배드민턴 대회 일정, 장소, 참가 방법을 한 화면에 모아 보여주던 서비스였습니다. 슈퍼베이스가 처음 만든 서비스입니다.",
